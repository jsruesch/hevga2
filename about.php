    ...
    <div class="container">
      ...
      <div class="row mar20-bot">
        ...
        <div class="row bg-lgrey">
          ...
          <div class="col-sm-6 col-md-4 pad20 ec-profile">
            <div class="row">
              <img src="img/portraits/portrait_tracy.png" class="center-block"/>
            </div>
            <div class="row mar15-top">
          ...
          <div class="col-sm-6 col-md-4 pad20 ec-profile">
            <div class="row">
              <img src="img/portraits/portrait_andrew.png" class="center-block"/>
            </div>
            <div class="row mar15-top">
          ...
          <div class="col-sm-6 col-md-4 pad20 ec-profile">
            <div class="row">
              <img src="img/portraits/portrait_drew.png" class="center-block"/>
            </div>
            <div class="row mar15-top">
          ...
          <div class="col-sm-6 col-md-4 pad20 ec-profile">
            <div class="row">
              <img src="img/portraits/portrait_katherine.png" class="center-block"/>
            </div>
            <div class="row mar15-top">
          ...
          <div class="col-sm-6 col-md-4 pad20 ec-profile">
            <div class="row">
              <img src="img/portraits/portrait_jonathan.png" class="center-block"/>
            </div>
            <div class="row mar15-top">
